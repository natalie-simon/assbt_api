...
export class Migration1739980290992 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "article" RENAME COLUMN "statutId" TO "statut"`);
        ...
        await queryRunner.query(`ALTER TABLE "article" ADD "statut" "public"."article_statut_enum" NOT NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "article" DROP COLUMN "statut"`);
        await queryRunner.query(`DROP TYPE "public"."article_statut_enum"`);
        await queryRunner.query(`ALTER TABLE "article" ADD "statut" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "article" RENAME COLUMN "statut" TO "statutId"`);
